...
if st.session_state["page"] == "page1":
    ...
    if neworold_scope == "Scope1":
        neworold_scope_equipment_options = ["","空調(ボイラ)","空調(冷凍機)","空調(ウォータチラー空冷式)","空調(ウォータチラー水冷式)","冷蔵/冷凍","給湯","発電","自動車","トラック","重機/建機(トラック除く)","船舶","航空機","化学薬品の原料","鉱業用原料・燃料","業務/産業 燃料","溶解炉","焼却炉","脱水・乾燥機","農林・水産","生産用ボイラー","バーナー","空調(GHP)(パッケージ式)","クリーンルーム用空調(ボイラ)","クリーンルーム用空調(冷凍機)","クリーンルーム用空調(ウォータチラー空冷式)","クリーンルーム用空調(ウォータチラー水冷式)","クリーンルーム用空調(GHP)(パッケージ式)","焼鈍炉","乾燥炉","焼結炉/焼成炉","ダイカストマシン","焼入れ炉","鍛造炉・鍛造加熱炉","メッキ槽・電着塗装","焼戻し炉","衣類用乾燥機","工業用乾燥機","自家用発電機","SCOPE1全体","その他(SCOPE1)"]
        ...
        neworold_scope_equipment_options = ["","空調(電気)(パッケージ式)",
        "空調(電気)(個別式)",
        "冷蔵/冷凍",
        "給湯",
        "照明",
...
# ** 2ページ目F (緑施策) **
    ...
    load_factor_table = {
        ...
        "空調(電気)(ウォータチラー水冷式)": 40, "攪拌機": 60,"コンクリートミキサー": 60, "充填機": 40,
